            ...
            <div class="card-actions justify-center">
                <blockquote class="text-2xl font-semibold italic text-center text-slate-900">
                    <span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-pink-500 relative inline-block">
                        <span class="relative text-white p-2">SOLD OUT!</span>
                    </span>
                </blockquote>
            </div>
        </div>
            ...
            <div class="card-actions justify-between">
                <div class="justify-start">
                    <select class="select select-primary" v-model="qtySelected">
                        <option disabled selected value="0">Select quantity</option>
                ...
                <div class="justify-end">
                    <button class="btn btn-primary" :disabled="!(qtySelected > 0)" v-on:click="addToCart">Add to cart</button>
                </div>
            </div>
        </div>
